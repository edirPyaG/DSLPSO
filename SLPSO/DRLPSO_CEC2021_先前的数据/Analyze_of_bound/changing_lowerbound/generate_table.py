...
DATASETS: tuple[Dataset, ...] = (
    Dataset(
        excel=ROOT / "comparison_results_lowerbound.xlsx",
        ...
        output=ROOT / "table_lowerbound.tex",
    ),
)

COLUMNS = ("Function", "Lower=10", "Lower=5", "Lower=20", "Lower=30", "Lower=50", "Lower=60")
BASELINE_COL = "Lower=10"  # 基准列名
...
def _generate_table(dataset: Dataset) -> None:
    ...
    for idx, row in df.iterrows():
        ...
        for col_idx, col_name in enumerate(COLUMNS):
            ...
            elif col_name == BASELINE_COL:  # 基准列 (Lower=10)
                # 检查是否是汇总行
